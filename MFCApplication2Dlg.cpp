...
void CMFCApplication2Dlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_EDIT1, m_detik);
}
...
void CMFCApplication2Dlg::OnBnClickedButton1()
{
	...
	UpdateData(TRUE);
	hari = m_detik / 86400;
	m_detik = m_detik - (86400 * hari);
	jam = m_detik / 3600;
	m_detik = m_detik - (3600 * jam);
	menit = m_detik / 60;
	m_detik = m_detik - (60 * menit);
	detik = m_detik / 1;
	UpdateData(TRUE);
	sprintf(chasil, "%d detik setara dengan %d hari, %d Jam, %d Menit dan % d detik", m_detik, hari, jam, menit, detik);
	//MessageBox(chasil, "Kotak Pesan");
	SetDlgItemText(IDC_EDIT2, chasil);
}
